...
export default function VariableEntityInspector({ item }: { item: TEntity }) {
    switch (true) {
        case item instanceof Character:
            return (<InspectCharacter characterData={item} />)
        case item instanceof Entity:
